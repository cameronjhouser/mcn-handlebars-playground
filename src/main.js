...
const REF_DATA = {
  ...
  comparison: [
    { name: 'and',    syntax: '{{and val1 val2 ...}} / {{#and ...}} ... {{/and}}',       desc: 'Logical AND. True if all values are truthy.' },
    { name: 'compare',syntax: '{{compare left "op" right}} / {{#compare ...}}',          desc: 'Compare two values. Ops: > < >= <= == !=. Auto-detects null/bool/date/number/string.' },
    ...
    { name: 'isEmpty',syntax: '{{isEmpty val}} / {{#isEmpty val}} ... {{/isEmpty}}',     desc: 'True if null, empty string, or empty array.' },
    { name: 'isNull', syntax: '{{isNull val}} / {{#isNull val}} ... {{/isNull}}',        desc: 'True if null or undefined.' },
    { name: 'not',    syntax: '{{not val}} / {{#not val}} ... {{/not}}',                 desc: 'Logical NOT.' },
    { name: 'or',     syntax: '{{or val1 val2 ...}} / {{#or ...}} ... {{/or}}',          desc: 'Logical OR. True if any value is truthy.' },
  ...
  utility: [
    ...
    { name: 'formatCurrency', syntax: '{{formatCurrency value [currency] [culture]}}',  desc: '⚠ Format as currency (Intl.NumberFormat). Default USD, en-US.' },
...
const DEVIATIONS = [
  ...
  { title: 'isEmpty / isNull / formatCurrency / formatNumber / indexOf / properCase', detail: 'Documentation pages returned 404. Implemented from category descriptions and standard behavior.' },
